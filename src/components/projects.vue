    ...
    <div class="h-full w-full flex items-center justify-start relative">
        ...
        >
            ...
            >
                ...
                <p class="max-[350px]:text-xs max-[640px]:text-md min-[640px]:text-xl" v-html="project.description.replace(/\n/g, '<br />')" />
            </div>
        </div>
        ...
        <button 
            class="
                ...
                hover:bg-lightBlue hover:text-dark active:bg-lightBlue active:text-dark
            "
