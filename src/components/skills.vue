    ...
    <div class="h-full w-full flex items-center justify-center relative">
        ...
        <div class="flex flex-col items-start justify-start max-[350px]:gap-2.5 min-[350px]:gap-5 px-5">
            <div v-for="skill in skills">
                ...
                <div class="flex flex-row justify-start max-[350px]:pt-1 min-[350px]:pt-2.5 max-[350px]:gap-2.5 min-[350px]:gap-5">
                    <button
                        v-for="technology in skill.technologies"
                        class="
                            max-[350px]:h-8 max-[640px]:h-12 min-[640px]:h-20 max-[350px]:w-8 max-[640px]:w-12 min-[640px]:w-20
                            flex items-center justify-center bg-darkLight shadow-2xl rounded-md p-1 hover:bg-white relative
