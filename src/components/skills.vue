<template>
    <div class="h-full w-full flex items-center justify-center relative">
        ...
        <div
            class="flex flex-col items-start justify-start max-[480px]:gap-2.5 min-[480px]:gap-5 px-5 max-[480px]:pt-10"
        >
            <div v-for="skill in skills">
                <span class="max-[480px]:text-xs max-[640px]:text-lg min-[640px]:text-xl">{{ skill.name }}</span>
                <div
                    class="flex flex-row justify-start max-[480px]:pt-1 min-[480px]:pt-2.5 max-[480px]:gap-2.5 min-[480px]:gap-5"
                >
                    <button
                        v-for="technology in skill.technologies"
                        class="max-[480px]:h-8 max-[640px]:h-12 min-[640px]:h-20 max-[480px]:w-8 max-[640px]:w-12 min-[640px]:w-20 flex items-center justify-center bg-darkLight shadow-2xl rounded-md p-1 hover:bg-white relative transition delay-0 duration-150 ease-in-out"
                    ...
                    >
                        ...
                        <span
                            :id="technology.name"
                            class="absolute -top-10 max-[480px]:text-sm max-[640px]:text-lg min-[640px]:text-xl bg-white text-dark p-1 shadow-2xl rounded-md text-nowrap"
                            hidden
                        >
                            {{ technology.name }}
                        </span>
